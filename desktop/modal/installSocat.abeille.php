...
?>
<div id='div_installSocatAbeilleAlert' style="display: none;"></div>
...
<br/><br/><br/>
<pre id='pre_abeilleInstallSocat' style='overflow: auto; height: 90%;with:90%;'>
...
<script>
    $.ajax({
        ...
        error: function (request, status, error) {
            handleAjaxError(request, status, error, $('#div_installSocatAbeilleAlert'));
        },
        success: function () {
        }
    });
