...
?>
<div id='div_installPiGpioAbeilleAlert' style="display: none;"></div>
...
<br/><br/><br/>
<pre id='pre_abeilleInstallPiGpio' style='overflow: auto; height: 90%;with:90%;'>
...
<script>
    $.ajax({
        ...
        data: {
            action: 'installPiGpio',
        },
        dataType: 'json',
        global: false,
        error: function (request, status, error) {
            handleAjaxError(request, status, error, $('#div_installPiGpioAbeilleAlert'));
        },
        success: function () {
        }
    });
    ...
    function updatelog(){
        jeedom.log.autoupdate({
            ...
            display: $('#pre_abeilleInstallPiGpio'),
