...
?>
<div id='div_installPackageAbeilleAlert' style="display: none;"></div>
...
<br/><br/><br/>
<pre id='pre_abeilleinstallPackage' style='overflow: auto; height: 90%;with:90%;'>
</pre>

<script>
    var package = "<?php echo $_GET['package']; ?>";
    ...
    $.ajax({
        ...
        error: function (request, status, error) {
            handleAjaxError(request, status, error, $('#div_installPackageAbeilleAlert'));
        },
        success: function () {
        }
    });
    ...
    function updatelog(){
        jeedom.log.autoupdate({
            ...
            display: $('#pre_abeilleinstallPackage'),
