...
?>
<div id='div_installTTYAbeilleAlert' style="display: none;"></div>
...
<br/><br/><br/>
<pre id='pre_abeilleInstallTTY' style='overflow: auto; height: 90%;with:90%;'>
...
<script>
    $.ajax({
        ...
        error: function (request, status, error) {
            handleAjaxError(request, status, error, $('#div_installTTYAbeilleAlert'));
        },
        success: function () {
        }
    });
