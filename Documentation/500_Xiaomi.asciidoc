...
Il est possible d'envoyer un message vers le capteur pour voir s'il répond. Le sensor va faire un bip. Après demande, il faut attendre au plus 15s (temps de réveil).
