...
?>
<div id='div_syncconfAbeilleAlert' style="display: none;"></div>
...
<br/><br/><br/>
<pre id='pre_abeillesyncconf' style='overflow: auto; height: 90%;with:90%;'>
...
<script>
    $.ajax({
        ...
        data: {
            action: 'syncconfAbeille',
        },
        dataType: 'json',
        global: false,
        error: function (request, status, error) {
            handleAjaxError(request, status, error, $('#div_syncconfAbeilleAlert'));
        },
        success: function () {
        }
    });
...
function updatelog(){
    jeedom.log.autoupdate({
                log: 'Abeille_syncconf',
                display: $('#pre_abeillesyncconf'),
