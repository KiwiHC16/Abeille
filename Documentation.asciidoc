...
* Capteur de porte, capteur de temperature rond/carre, bouton et capteur infrarouge Xiaomi, un appuie long (plus de 6s, led flash) sur le bouton sur le côté. Et vous devriez récupérer l'objet dans Jeedom.
