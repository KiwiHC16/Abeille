<?php
    ...
    foreach ($eqLogics as $eqLogic) {
        ...
        $eqList[$eqLogicId]['name'] = $eqLogic->getName();
        $eqParent = $eqLogic->getObject();
        if (!is_object($eqParent))
            $objName = "";
        else
            $objName = $eqParent->getName();
        $eqList[$eqLogicId]['parent'] = $objName;
        $eqList[$eqLogicId]['ieee'] = $eqLogic->getConfiguration('IEEE', '');
        $eqList[$eqLogicId]['icon'] = $eqLogic->getConfiguration('ab::icon', 'defaultUnknown');
