...
J’ai aussi intégré un « sous-plugin » [TIMER](index.md#présentation) qui fonctionne à la seconde dans ce plugin. Il faudra peut être que je fasse un plugin dédié et indépendant.
