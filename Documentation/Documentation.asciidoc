...
- Créer un répertoire Abeille dans le repertoire des plugins et installer les fichiers (Cette etape est pour l instant manuelle, le plugin doit être aussi disponible maintenant dans le market.).
