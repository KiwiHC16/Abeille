        ...
        success: function (json_res) {
            ...
            if (res.status != 0) {
                ...
                if (_autoUpdate) {
                    ...
                    setTimeout(function () {
                        trackLQICollectStatus(_autoUpdate, zigateX);
                    }, 1000);
                } else {
        ...
        if (res.status != 0) {
            ...
            for (var nodeFromJson in json.data) {
                ...
                if (currentJsonNode.Voisine_Name == null) {
                    ...
                    console.log(
                        "current node - voisine name empty - so I give IEEE as a name"
                    );
                }
                ...
                if (currentJsonNode.NE == null) {
                    ...
                    console.log(
                        "current node - NE name empty - so I give IEEE as a name"
                    );
                }
                ...
                if (typeof nodes[currentJsonNode.NE] == "undefined") {
                    ...
                    console.log(
                        "current node - It s a new node so I create it in the table from source : " +
                            JSON.stringify(nodes[currentJsonNode.NE])
                    );
                ...
                if (typeof nodes[currentJsonNode.Voisine] == "undefined") {
                    ...
                    nodes[currentJsonNode.Voisine].name =
                        currentJsonNode.Voisine_Name;
                    nodes[currentJsonNode.Voisine].object =
                        currentJsonNode.Voisine_Objet;
                    nodes[currentJsonNode.Voisine].links = [];
                    nodes[currentJsonNode.Voisine].route = 1;
                    nodes[currentJsonNode.Voisine].lqi =
                        currentJsonNode.LinkQualityDec;
                    nodes[currentJsonNode.Voisine].Type = currentJsonNode.Type;
                    console.log(
                        "current node - It s a new node so I create it in the table from voisine : " +
                            JSON.stringify(nodes[currentJsonNode.Voisine])
                    );
                }
            ...
            console.log(
                "node ruche (" +
                    zigateX +
                    "): " +
                    JSON.stringify(nodes["Abeille" + zigateX + "/0000"])
            );
            ...
            for (node in nodes) {
                ...
                else var nodeName = nodes[node].name;
                    ...
                    .node(function (node) {
                        ...
                        if (typeof node.data != "undefined") {
                            if (typeof node.data.Type != "undefined") {
                                console.log(
                                    "Txt: " + JSON.stringify(node.data.Type)
                                );
        ...
        if (res.status != 0) {
            ...
            for (var nodeFromJson in nodes) {
                ...
                if (nodes[nodeFromJson].Voisine_Name == null) {
                    nodes[nodeFromJson].Voisine_Name =
                        nodes[nodeFromJson].IEEE_Address;
                }
                ...
                nodesTo[nodes[nodeFromJson].Voisine] =
                    nodes[nodeFromJson].Voisine_Name;
