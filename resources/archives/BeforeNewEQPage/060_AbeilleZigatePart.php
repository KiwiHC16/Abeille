<br/>
<legend><i class="fas fa-cogs"></i> {{Gestion des parametres Zigate}}</legend>
<div class="form-group" style="background-color: rgba(var(--defaultBkg-color), var(--opacity)) !important; padding-left: 10px">
	...
	<form action="plugins/Abeille/desktop/php/AbeilleFormAction.php" method="post">
		...
		<br/>
		<label style="margin-right : 20px">Channel Mask</label>
		<a class="btn btn-primary btn-xs" target="_blank" href="http://kiwihc16.free.fr/Radio.html#zigate-channel-selection"><i class="fas fa-book"></i>Documentation</a>
		<br/>
		...
		<label style="margin-right : 20px">Extended PANID</label>
		<a class="btn btn-primary btn-xs" target="_blank" href="http://kiwihc16.free.fr/Radio.html"><i class="fas fa-book"></i>Documentation</a>
		<br/>
		...
		<label style="margin-right : 20px">Tx Power</label>
		<a class="btn btn-primary btn-xs" target="_blank" href="http://kiwihc16.free.fr/Radio.html"><i class="fas fa-book"></i>Documentation</a>
		<br/>
