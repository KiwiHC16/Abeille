...
=======
                <label class="col-lg-4 control-label" data-toggle="tooltip" title="{{Blocage off/on sur Zigate USB sans vie}}">{{Blocage ON/OFF Zigates USB : }}</label>
                <div class="col-lg-5">
                    <select class="configKey form-control" data-l1key="ab::preventUsbPowerCycle" style="width:150px" data-toggle="tooltip" title="{{Si 'oui', empeche l'interrogation du réseau tout les jours à minuit}}">
                        <option value="yes">{{Oui}}</option>
                        <option value="no" selected>{{Non}}</option>
